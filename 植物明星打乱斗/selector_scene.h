...
extern IMAGE img_gloomshroom_selector_background_left;			// 选择界面向左大喷菇背景图片
extern IMAGE img_gloomshroom_selector_background_right;			// 选择界面向右大喷菇背景图片

extern Atlas atlas_peashooter_idle_right;						// 婉逗射手朝向右的默认动画图集
extern Atlas atlas_sunflower_idle_right;						// 龙日葵朝向右的默认动画图集
extern Atlas atlas_gloomshroom_idle_right;						// 大喷菇朝向右的默认动画图集

extern IMAGE img_avatar_peashooter;								// 婉逗射手头像图片
extern IMAGE img_avatar_sunflower;								// 龙日葵头像图片
extern IMAGE img_avatar_gloomshroom;							// 大喷菇头像图片
...
private:
	...
	POINT pos_img_1P_desc = { 0 };					// 1P 按键描述图片位置
	POINT pos_img_2P_desc = { 0 };					// 2P 按键描述图片位置
	POINT pos_img_1P_name = { 0 };					// 1P 角色姓名文本描述位置
	POINT pos_img_2P_name = { 0 };					// 2P 角色姓名文本描述位置
	...
	POINT pos_2P_selector_btn_left = { 0 };			// 2P 向右切换按钮位置
	POINT pos_2P_selector_btn_right = { 0 };		// 2P 向右切换按钮位置

	Animation animation_peashooter;					// 豌豆射手动画
	Animation animation_sunflower;					// 龙日寇动画
	Animation animation_gloomshroom;				// 大喷菇动画

	PlayerType player_type_1 = PlayerType::Peashooter;// 1P 玩家类型
	PlayerType player_type_2 = PlayerType::Sunflower; // 2P 玩家类型

	LPCTSTR str_peashooter_name = _T("豌豆射手");	// 豌豆射手名
	LPCTSTR str_sunflower_name = _T("龙日葵");		// 龙日葵名
	LPCTSTR str_gloomshroom_name = _T("大喷菇");	// 大喷菇名

	int selector_background_scorll_offset_x = 0;	// 背景滑动距离

	bool is_btn_1P_left_down = false;				// 1P 向左切换按下
	bool is_btn_1P_right_down = false;				// 1P 向右切换按下
	bool is_btn_2P_left_down = false;				// 2P 向左切换按下
	bool is_btn_2P_right_down = false;				// 2P 向右切换按下
