...
IMAGE img_gloomshroom_selector_background_left;			// 选择界面向左大喷菇背景图片
IMAGE img_gloomshroom_selector_background_right;		// 选择界面向右大喷菇背景图片
...
Atlas atlas_gloomshroom_idle_left;						// 大喷菇向左默认动画图集
Atlas atlas_gloomshroom_idle_right;						// 大喷菇向右默认动画图集
Atlas atlas_gloomshroom_run_left;						// 大喷菇向左奔跑动画图集
Atlas atlas_gloomshroom_run_right;						// 大喷菇向右奔跑动画图集
Atlas atlas_gloomshroom_attack_ex_left;					// 大喷菇向左特殊攻击动画图集
Atlas atlas_gloomshroom_attack_ex_right;				// 大喷菇向右特殊攻击动画图集
Atlas atlas_gloomshroom_die_left;						// 大喷菇向左死亡动画图集
Atlas atlas_gloomshroom_die_right;						// 大喷菇向右死亡动画图集
...
Atlas atlas_bubbles;									// 气泡攻击动画图集
Atlas atlas_bubbles_ex;									// 气泡特殊攻击动画图集
...
IMAGE* img_player_1_avatar = nullptr;						// 玩家 1 头像
IMAGE* img_player_2_avatar = nullptr;						// 玩家 2 头像
...
void load_game_resources() {
	...
	mciSendString(_T("open resources/bubbles_shot.mp3 alias bubble_shot"), NULL, 0, NULL);
	mciSendString(_T("open resources/bubbles_shot_ex.mp3 alias bubble_shot_ex"), NULL, 0, NULL);
